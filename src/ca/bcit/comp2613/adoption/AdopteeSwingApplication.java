...
public class AdopteeSwingApplication {
    ...
    private JLabel lblAdoptionYear;
    private JLabel lblAgeAtAdoption;
    private JLabel lblSocialWorker;    
    ...
    private void initTable() {
        ...
        //table = new JTable(swingAdopteeModel);
    ...
    public void doSave() {
        ...
        String socialWorker = socialWorkerTextField.getText();          
        Adoptee adoptee = new Adoptee(id, firstName, lastName, null, null, gender, region, socialWorker, null);
    ...
    private void refreshTable() {
        //swingAdopteeModel = new SwingAdopteeModel();
        Object[][] data = null;
        ...
        swingAdopteeModel.setDataVector(data, columnNames);
        table.repaint();
    }
